 ...
 * @author cknoll1
 */
public class WindowCriteria_5_9_0_Test extends AbstractDatabaseTest {

  private final static Logger LOG = LoggerFactory.getLogger(WindowCriteria_5_9_0_Test.class);
