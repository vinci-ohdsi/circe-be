 ...
 * @author cknoll1
 */
public class CriteriaQuery_5_9_0_Test extends AbstractDatabaseTest {

  private final static Logger log = LoggerFactory.getLogger(CriteriaQuery_5_9_0_Test.class);
